...
function darkside(p1,tr){
	...
	if(p1!="" && p1!=null){
		...
		for(var k=1;k<=ccghm;k++){
			...
			}else var out="Sorry, no valid BIN is inserted, or BIN is incomplete, check if the format is correct, example: '666666xxxxxxxxxx' ";
		}
		if(jou==2) var out=out+"</xml>";
		else if(jou==3) var out=out+"}";
...
function cleanText(){
	var confirmar=confirm("Do you want to clean the generated cards list?");
